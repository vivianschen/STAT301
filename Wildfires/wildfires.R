...
library(leaps)
regfit.full=regsubsets(sales~. , data=training, nvmax=15, really.big = T)
...
#Now perform best subset selection on the full data set to get the 6 variable model
